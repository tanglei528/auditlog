...
class Resource(Model):
    ...
    dict = {"^(/v2.0/networks)": {"1.2.1": "Networks"},
            ...
            "^(/v2.0/floatingips)": {"1.2.5": "Floating IPs"},
            ...
            "^(/v2/).*?(\/os-services)": {"2.2.22": "Services"},
            "^(/v2/).*?(\/os-volumes)": {"2.2.23": "Server Volumes"},
            "^(/v2/).*?(\/os-snapshots)": {"2.2.24": "Server Snapshots"},
            ...
            "^(/v2/).*?(\/backups)": {"3.2.4": "Backups"},
            "^(/v2/images)": {"4.2.1": "Images"},
            "^(/v2/images/).*?(\/tags)": {"4.2.2": "Image Tags"},
            "^(/v2/images/).*?(\/members)": {"4.2.3": "Image Members"}
            }
