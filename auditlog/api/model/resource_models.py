...
class Resource(object):
    ...
    dict = {"^(/v2.0/networks)":{"1.2.1":"NetWorks"},
            ...
            "^(/v2/).*?(\/flavors).*?(\/os-extra_specs)":{"2.2.2":"Flavor extra-specs"},
            ...
            "^(/v2/).*?(\/servers).*?(\/os-attach-interfaces)":{"2.2.8":"Attach interfaces"},
            "^(/v2/).*?(\/os-coverage)":{"2.2.9":"Coverage reports"},
            "^(/v2/).*?(\/os-fixed-ips)":{"2.2.10":"Fixed IP"},
            "^(/v2/).*?(\/os-floating-ipdns)":{"2.2.11":"Floating IP DNS records"},
            "^(/v2/).*?(\/os-floating-ips)":{"2.2.12":"Floating IPs"},
            "^(/v2/).*?(\/os-floating-ipsbulk)":{"2.2.13":"Floating IPs bulk"},
            ...
            "^(/v2/).*?(\/os-security-group-rules)":{"2.2.18":"Rules for default security group"},
            ...
            "^(/v2/).*?(\/servers).*?(\/os-volume_attachments)":{"2.2.25":"Volume attachments"},
            ...
            "^(/v2/).*?(\/os-quota-sets)":{"3.2.4":" Quota sets extension(os-quota-sets)"},
