# AuditLog documentation build configuration file, created by
...
def write_autodoc_index():
    ...
    EXCLUDED_MODULES = ('auditlog.api.tests', 'auditlog.openstack.common')
    CURRENT_SOURCES = {}
...
# FIXME [xg.song] We need install vscloudsphix theme ext mannually, which is
# no so kindly, so use OpenStack theme first.
#              'vscloudsphinx',
              'oslosphinx',
              ]
...
project = u'AuditLog'
copyright = u'2014, Venusource Ltd. Co.'
...
version = auditlog.version.version_info.version_string()
# The full version, including alpha/beta/rc tags.
release = auditlog.version.version_info.release_string()
...
# [howto/manual]).
latex_documents = [
    ('index', 'AuditLog.tex', u'AuditLog Documentation',
...
man_pages = [
    ('index', 'auditlog', u'AuditLog Documentation',
     [u'VSCloud'], 1)
]
...
texinfo_documents = [
    ('index', 'AuditLog', u'AuditLog Documentation', u'VSCloud',
     'AuditLog', 'Auditlog is used to gather and view logs in a cloud.',
     'Miscellaneous'),
]
...
epub_title = u'AuditLog'
epub_author = u'Venusource'
epub_publisher = u'Venusource'
epub_copyright = u'2014, Venusource'
